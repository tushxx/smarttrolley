...
// Weights in grams — used for two-factor detection (camera + load cell)
const DEMO_PRODUCTS: Product[] = [
  { id: "p1", name: "Appy Fizz",      brand: "Parle Agro",  description: "Sparkling apple juice drink 250ml",          price: "40.00",  detectionClass: "APPY FIZZ",     imageUrl: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&h=300&fit=crop", category: "Beverages",     weight: "275.000", unit: "grams", createdAt: new Date() },
  { id: "p2", name: "Frooti",         brand: "Parle Agro",  description: "Mango fruit drink 200ml Tetra Pak",          price: "20.00",  detectionClass: "FROOTI",        imageUrl: "https://images.unsplash.com/photo-1546173159-315724a31696?w=300&h=300&fit=crop", category: "Beverages",     weight: "210.000", unit: "grams", createdAt: new Date() },
