...
export const PRODUCT_WEIGHT_TOLERANCE_G = 45;
...
const DEMO_PRODUCTS: Product[] = [
  { id: "p1", name: "Appy Fizz",      brand: "Parle Agro",  description: "Sparkling apple juice drink 250ml",          price: "40.00",  detectionClass: "APPY FIZZ",     imageUrl: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&h=300&fit=crop", category: "Beverages",     weight: "257.000", unit: "each", createdAt: new Date() },
  { id: "p2", name: "Frooti",         brand: "Parle Agro",  description: "Mango fruit drink 200ml Tetra Pak",          price: "20.00",  detectionClass: "FROOTI",        imageUrl: "https://images.unsplash.com/photo-1546173159-315724a31696?w=300&h=300&fit=crop", category: "Beverages",     weight: "347.000", unit: "each", createdAt: new Date() },
  { id: "p3", name: "Moisturizer",    brand: "Nivea",       description: "Daily moisturizing cream for all skin types", price: "299.00", detectionClass: "MOISTURIZER",   imageUrl: "https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=300&h=300&fit=crop", category: "Personal Care", weight: "307.000", unit: "each", createdAt: new Date() },
